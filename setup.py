...
setup(
    ...
    package_data={
        'base': [
            ...
            'static/vendor/css/photoswipe/*.*',
            'static/vendor/css/photoswipe/default-skin/*.*',
            ...
            'static/vendor/js/ckeditor/plugins/a11yhelp/*.*',
            'static/vendor/js/ckeditor/plugins/a11yhelp/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/a11yhelp/dialogs/lang/*.*',
            ...
            'static/vendor/js/ckeditor/plugins/magicline/*.*',
            'static/vendor/js/ckeditor/plugins/magicline/images/*.*',
            'static/vendor/js/ckeditor/plugins/magicline/images/hidpi/*.*',
            'static/vendor/js/ckeditor/plugins/pastefromword/*.*',
            'static/vendor/js/ckeditor/plugins/pastefromword/filter/*.*',
            'static/vendor/js/ckeditor/plugins/scayt/*.*',
            'static/vendor/js/ckeditor/plugins/scayt/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/specialchar/*.*',
            'static/vendor/js/ckeditor/plugins/specialchar/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/specialchar/dialogs/lang/*.*',
            'static/vendor/js/ckeditor/plugins/table/*.*',
            'static/vendor/js/ckeditor/plugins/table/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/tabletools/*.*',
            'static/vendor/js/ckeditor/plugins/tabletools/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/wsc/*.*',
            'static/vendor/js/ckeditor/plugins/wsc/dialogs/*.*',
            'static/vendor/js/ckeditor/plugins/youtube/*.*',
            'static/vendor/js/ckeditor/plugins/youtube/images/*.*',
            'static/vendor/js/ckeditor/plugins/youtube/lang/*.*',
            ...
            'static/vendor/js/ckeditor/samples/plugins/htmlwriter/*.*',
            'static/vendor/js/ckeditor/samples/plugins/htmlwriter/assets/*.*',
            'static/vendor/js/ckeditor/samples/plugins/htmlwriter/assets/outputforflash/*.*',
            'static/vendor/js/ckeditor/samples/plugins/magicline/*.*',
            ...
            'static/vendor/js/codemirror/*.*',
            'static/vendor/js/html5shiv/*.*',
            'static/vendor/js/nvd3/*.*',
            'static/vendor/js/photoswipe/*.*',
