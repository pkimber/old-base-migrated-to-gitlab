...
setup(
    ...
    package_data={
        'base': [
            ...
            'static/vendor/css/zebra_datepicker/metallic/*.*',
            'static/vendor/js/*.*',
            'static/vendor/js/chosen/*.*',
            ...
            'static/vendor/js/ckeditor/plugins/justify/*.*',
            'static/vendor/js/ckeditor/plugins/justify/icons/*.*',
            'static/vendor/js/ckeditor/plugins/justify/icons/hidpi/*.*',
            'static/vendor/js/ckeditor/plugins/justify/lang/*.*',
